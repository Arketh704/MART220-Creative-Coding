...
function preload() {
  ...
  myAnimation = new animationImage(fileNames, 0, 200, innerWidth / 6, innerHeight / 4, 4);
...
function draw() {
  ...
  image(shroom, shroomX, shroomY, shroom.width / 8, shroom.height / 6);
  ...
  drawRamen();
  drawShapes();
  myAnimation.updatePos(myAnimation.x + 2);
